...
.tab-header2 {
  	width: 92px;
  	border-bottom: 4px solid #5bcfc5;
  	box-sizing: border-box;
  	height: 51px;
  	display: flex;
  	flex-direction: row;
...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper" style="overflow-x: scroll;">
         ...
         <div class="content-body" style="width:100% ; margin-left: -1%;    margin-top: -7%;    overflow-x: scroll;">
            <!-- row -->
  	...
  	<div class="page-box">
		<nav class="navbar navbar-expand-sm navbar-light bg-white fixed-top shadow-sm">
			<div class="container-fluid flex-column">
				<!-- العنوان والزر الجوال -->
				<div class="d-flex align-items-center">
					<div class="navbar-brand large-bold">ابحث عن ما تريد من هنا</div>
					<button class="navbar-toggler me-2" type="button" data-bs-toggle="collapse" data-bs-target="#navbarFilters">
			  ...
			  <form method="get" action="resrv2" id="resrv2" class=" p-4">   
				  <div class="row flex-sm-row justify-content-center gap-2" >
					{{-- نوع الاضحية --}}
			  ...
			  <select name="type" id="type_" class="form-control text-center" 
									style="
width: 100%;
...
color: #525252;">
										...
										@php $get_type = DB::table('adahy_type')->get(); @endphp
					...
					<div class="drop-list-tool">
						<div class="div1">
							  ...
							  <div id="type_show" style="    width: 100%;">
														  <select name="sak"  class="form-control text-center" 
									style="
width: 100%;
border-radius: 10px;
border-color: #d3cec7;
...
color: #525252;">
		  ...
		  <select name="c_sak"  class="form-control text-center" 
									style="
width: 100%;
border-radius: 10px;
border-color: #d3cec7;
					 ...
					 <div class="drop-list-tool">
						<div class="div1">
							...
							<div class="div2">
							  ...
							  <select name="times"  class="form-control text-center" 
							  style="
 width: 100%;
  border-radius: 10px;
  border-color: #d3cec7;
  ...
  color: #525252;">
													   <option value="">الكل</option>
										@php $get_type = DB::table('times')->get(); @endphp
										@foreach($get_type as $g)
						...
						<div class="d-inline-flex justify-content-center w-auto align-items-center align-items-sm-end gap-2 pt-4 mb-sm-1">
						 <a href="resrv2?gov={{ $gov }}" style="text-decoration:none;width: 52px;">
							  <div class="btn w-100">
		...
		@media (min-width: 576px) {
    		...
    		<div class="cards-frame container-2" style="direction: ltr;">
      			<div class="frame-parent">
        				...
        				<div class="shifts-parent">
        				    ...
        				    @php $get_data = DB::table('times')->where(function($query) use ($times) {
        				        if($times)
      ...
      <div class="modal-header">
       ...
       @switch($gs->gov)
		   ...
		   @case(24)
			   ...
			   @break		   
	   @endswitch
       -<b style="color: red;">{{ $gs->is_available == 1 ? "صكوك متاحة للتبرع بالكامل" :""}}</b>
        </h5>
...
<div class="modal fade" id="selectSakModal{{$gs->id}}" tabindex="-1" role="dialog" aria-labelledby="selectSakLabel" aria-hidden="true">
	<div class="modal-dialog" role="document" style="direction: ltr;">
...
<div class="modal fade" id="stepTwoModal{{$gs->id}}" tabindex="-1" role="dialog" aria-labelledby="stepTwoLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
	  <div class="modal-content p-3">
		<form method="get" action="resrv3" id="reservationForm{{$gs->id}}">
		  <input type="hidden" name="id" value="{{ $gs->id }}">
		  <input type="hidden" name="times" value="{{ $get->id }}">
		  <input type="hidden" name="day" value="{{ $day }}">
		  <input type="hidden" name="c_sak" id="hiddenSak{{$gs->id}}">
		  <input type="hidden" name="c_persons" id="hiddenPersons{{$gs->id}}">
		  <h5 class="modal-title mb-3">الخطوة الثانية: <b style="color: #000">اختر عدد الاشخاص</b>  </h5>
		  ...
		  <div class="form-group">
			<label><b style="color: #000">	اختر عدد الأشخاص </b></label>
...
<!-- Modal -->  
            						...
            						<div @if($gs->free == 0  ||   $is_available != $gs->is_available) class="cards" @else class="cards2" @endif>
              							<div @if($gs->free == 0) class="circle-one" @else class="circle-half" @endif>
              							    ...
              							    @else
                								...
                								{{-- <div class="circle" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#exampleModal{{$gs->id}}"> --}}
                  								...
                  								<div class="parent2 {{ $gs->free == 0 ? 'd-none' : '' }}">
              							...
              							<div class="title-number text-center">
                								<b class="b w-100" @if($gs->free == 0) style="" @endif>
                								...
                								<div class="parent w-100" style="direction: ltr;">
