                                    ...
                                    <div class="modal fade" id="exampleModalCenter">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                                <form method="post" action="new_follower">
                                        @csrf
    ...
    font-weight: bold;">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="الاسم" Required>
                                ...
                                @enderror
                                            ...
                                            <div class="mb-12 col-md-12">
                                                <label class="form-label">المرحلة التشغلية*</label>
                                                <select class="form-control @error('note') is-invalid @enderror" name="note" required>
                                                    <option value="">اختر المرحلة</option>
                                                    <option value="مشرف جزار" {{ old('note') == 'مشرف جزار' ? 'selected' : '' }}>مشرف جزار</option>
                                                    <option value="مشرف سقط" {{ old('note') == 'مشرف سقط' ? 'selected' : '' }}>مشرف سقط</option>
                                                    <option value="مشرف تعبئة" {{ old('note') == 'مشرف تعبئة' ? 'selected' : '' }}>مشرف تعبئة</option>
                                                    <option value="مشرف نقل اللحوم" {{ old('note') == 'مشرف نقل اللحوم' ? 'selected' : '' }}>مشرف نقل اللحوم</option>
                                                    <option value="مشرف غرفة التبريد" {{ old('note') == 'مشرف غرفة التبريد' ? 'selected' : '' }}>مشرف غرفة التبريد</option>
                                                    <option value="نقل وتوصيل" {{ old('note') == 'نقل وتوصيل' ? 'selected' : '' }}>نقل وتوصيل</option>
                                                    <option value="مشرف غرفة الخراف" {{ old('note') == 'مشرف غرفة الخراف' ? 'selected' : '' }}>مشرف غرفة الخراف</option>
                                                    <option value="مشرف تسليم " {{ old('note') == 'مشرف تسليم ' ? 'selected' : '' }}>مشرف تسليم </option>
                                                    {{-- <option value="مشرف تسليم - غرفة 2" {{ old('note') == 'مشرف تسليم - غرفة 2' ? 'selected' : '' }}>مشرف تسليم - غرفة 2</option>
                                                    <option value="مشرف تسليم - غرفة 3" {{ old('note') == 'مشرف تسليم - غرفة 3' ? 'selected' : '' }}>مشرف تسليم - غرفة 3</option>
                                                    <option value="مشرف تسليم - غرفة 4" {{ old('note') == 'مشرف تسليم - غرفة 4' ? 'selected' : '' }}> مشرف تسليم - غرفة 4</option>
                                                    <option value="مشرف تسليم - غرفة 5" {{ old('note') == 'مشرف تسليم - غرفة 5' ? 'selected' : '' }}> مشرف تسليم - غرفة 5</option>
                                                    <option value="مشرف تسليم - غرفة 6" {{ old('note') == 'مشرف تسليم - غرفة 6' ? 'selected' : '' }}> مشرف تسليم - غرفة 6</option>
                                                    <option value="مشرف تسليم - غرفة 7" {{ old('note') == 'مشرف تسليم - غرفة 7' ? 'selected' : '' }}> مشرف تسليم - غرفة 7</option> --}}
                                                </select>
                                                @error('note')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                    ...
                                    <div class="modal fade" id="Modaledit">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                                <form method="post" action="edit_follower">
                                        @csrf
    ...
    font-weight: bold;">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="edit_name" name="name" value="{{ old('name') }}" placeholder="الاسم" Required>
                                ...
                                @enderror
                                            ...
                                            <div class="mb-12 col-md-12">
                                                <label class="form-label">المرحلة التشغلية*</label>
                                                <select class="form-control @error('note') is-invalid @enderror" id="edit_note" name="note" required>
                                                    <option value="">اختر المرحلة</option>
                                                    <option value="مشرف جزار" {{ old('note') == 'مشرف جزار' ? 'selected' : '' }}>مشرف جزار</option>
                                                    <option value="مشرف سقط" {{ old('note') == 'مشرف سقط' ? 'selected' : '' }}>مشرف سقط</option>
                                                    <option value="مشرف تعبئة" {{ old('note') == 'مشرف تعبئة' ? 'selected' : '' }}>مشرف تعبئة</option>
                                                    ...
                                                    <option value="مشرف غرفة الخراف" {{ old('note') == 'مشرف غرفة الخراف' ? 'selected' : '' }}>مشرف غرفة الخراف</option>
                                                     <option value="مشرف تسليم" {{ old('note') == 'مشرف تسليم' ? 'selected' : '' }}>مشرف تسليم </option>
                                                    {{-- <option value="مشرف تسليم - غرفة 1" {{ old('note') == 'مشرف تسليم - غرفة 1' ? 'selected' : '' }}>مشرف تسليم - غرفة 1</option>
                                                    <option value="مشرف تسليم - غرفة 2" {{ old('note') == 'مشرف تسليم - غرفة 2' ? 'selected' : '' }}>مشرف تسليم - غرفة 2</option>
                                                    <option value="مشرف تسليم - غرفة 3" {{ old('note') == 'مشرف تسليم - غرفة 3' ? 'selected' : '' }}>مشرف تسليم - غرفة 3</option>
                                                    <option value="مشرف تسليم - غرفة 4" {{ old('note') == 'مشرف تسليم - غرفة 4' ? 'selected' : '' }}>مشرف تسليم - غرفة 4</option>
                                                    <option value="مشرف تسليم - غرفة 5" {{ old('note') == 'مشرف تسليم - غرفة 5' ? 'selected' : '' }}>مشرف تسليم - غرفة 5</option>
                                    ...
                                    <div class="modal fade" id="Modaldel">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                                <form method="post" action="del_follower">
                                        @csrf
                                    ...
                                    <table class="table table-striped table-responsive-sm" style="width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$g->name}}</td>
                                                <td>{{$g->note}}</td>
                                              <td>{{@tr_follower::where('treasury_id',$g->id)->orderBy('id','DESC')->first()->total}}</td>
