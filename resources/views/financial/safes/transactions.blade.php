...
<div class="col-12" style="direction:rtl">
    <div class="card">
        <div class="card-header border-0 pb-0">
            <h5 class="card-title">سجل الحركات المالية</h5>
                ...
                <table class="table table-responsive-md">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $m->id }}</td>
                            <td>
                                @php $types=['payment'=>'دفع','transfer'=>'تحويل','deposit'=>'إيداع','withdrawal'=>'سحب'];
                                $colors=['payment'=>'success','transfer'=>'info','deposit'=>'primary','withdrawal'=>'danger']; @endphp
                                <span class="badge badge-{{ $colors[$m->type]??'secondary' }} light">{{ $types[$m->type]??$m->type }}</span>
                            </td>
