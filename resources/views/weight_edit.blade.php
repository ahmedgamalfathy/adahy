					...
					<div class="col-xl-3 col-xxl-6 col-sm-6 d-none d-sm-block">
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"> 
										    {{DB::table('opt')->where('type',1)->count();}}
									</h2>
									<span class="text-white fs-18">
									    مرحلة الوزن
									</span>
...
">
                                    ...
                                    <div class="modal fade" id="Modaledit{{$g->id}}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                                <form method="post" action="add_weight2">
                                        @csrf
                                                
                                                <input type="hidden" name="code" id="edit_id" value="{{$g->code}}">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"> إضافة وزن </h5>
    ...
    font-weight: bold;">
                                ...
                                <input type="text" onkeypress="return event.charCode >= 46 && event.charCode <= 58" class="form-control @error('weight') is-invalid @enderror" name="weight" id="weight" value="{{$gs->w_weight}}" placeholder="الوزن " Required>
                                ...
                                @enderror
                                                          ...
                                                          <div class="mb-12 col-md-12">
                                                <label class="form-label">الشقتين *</label>
                        
                                <input type="text" onkeypress="return event.charCode >= 46 && event.charCode <= 58" class="form-control @error('weight') is-invalid @enderror" name="b_weight" id="b_weight" value="{{$gs->b_weight}}" placeholder="الشقتين " Required>
                                ...
                                <input type="text" onkeypress="return event.charCode >= 46 && event.charCode <= 58" class="form-control @error('weight') is-invalid @enderror" name="f_weight" id="f_weight" value="{{$gs->f_weight}}" placeholder="اللحم بعد التشفية " Required>
                                ...
                                <input type="text" onkeypress="return event.charCode >= 46 && event.charCode <= 58" class="form-control @error('weight') is-invalid @enderror" name="f_weight2" id="f_weight2" value="{{$gs->f_weight2}}" placeholder="وزن الكبدة " Required>
                        ...
                        <a href="#" class="btn btn-warning  shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target="#Modaledit{{$g->id}}"><i class="fa fa-pencil"></i></a>                            
                                                ...
                                                <td>{{$gs->w_weight}}</td>
                                                <td>{{$gs->b_weight}}</td>
                                                <td>{{number_format($gs->b_case,2)}}</td>
                                                <td>{{$gs->f_weight}}</td>
                                                <td>{{$gs->f_weight2}}</td>
                                                <td>{{ number_format($gs->f_case,2)}}</td>
                                    ...
                                    <div class="modal fade" id="Modaladd{{$g->id}}">
                                        ...
                                        @csrf
                                                ...
                                                <input type="hidden" name="code" id="edit_id" value="{{$g->id}}">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"> إضافة وزن </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                                                    </button>
    ...
    font-weight: bold;">
                  ...
                  <? echo $all_v; ?>
                                ...
                                <input type="text" onkeypress="return event.charCode >= 46 && event.charCode <= 58" class="form-control @error('weight') is-invalid @enderror" name="weight" id="weight" value="{{ old('weight') }}" placeholder="الوزن " Required>
