...
<body>
    ...
    ***********************************-->
                                    ...
                                    <div class="modal fade" id="exampleModalCenter">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                                <form method="post" action="new_sak">
                                        @csrf
                                                <div class="modal-header">
                                                    <h5 class="modal-title"> نوع الصك</h5>
    ...
    font-weight: bold;">
                        ...
                        <input type="text" onkeypress="return event.charCode >= 46 && event.charCode <= 58" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" placeholder="السعر" Required>
                                                   @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                                                ...
                                                <div class="mb-12 col-md-12">
                                                <label class="form-label">سعر الذبح*</label>
                        <input type="text" onkeypress="return event.charCode >= 46 && event.charCode <= 58" class="form-control @error('price2') is-invalid @enderror" name="price2" value="{{ old('price2') }}" placeholder="سعر الذبح" Required>
                                                   @error('price2')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <input type="text" onkeypress="return event.charCode >= 46 && event.charCode <= 58" class="form-control @error('count') is-invalid @enderror" name="count" value="{{ old('count') }}" placeholder="العدد" Required>
                                                   @error('count')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                                    ...
                                    <div class="modal fade" id="Modaledit">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                                <form method="post" action="edit_sak">
                                        @csrf
    ...
    font-weight: bold;">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="edit_name" name="name" value="{{ old('name') }}" placeholder="الاسم" Required>
                                ...
                                @enderror
                                                                    ...
                                                                    <div class="mb-12 col-md-12">
                                                <label class="form-label">السعر*</label>
                        <input type="text" onkeypress="return event.charCode >= 46 && event.charCode <= 58" id="edit_price" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" placeholder="السعر" Required>
                                                   @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                                                     ...
                                                     <div class="mb-12 col-md-12">
                                                <label class="form-label">سعر الذبح*</label>
                        <input type="text" onkeypress="return event.charCode >= 46 && event.charCode <= 58" id="edit_price2" class="form-control @error('price2') is-invalid @enderror" name="price2" value="{{ old('price2') }}" placeholder="سعر الذبح" Required>
                                                   @error('price2')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                                                                    ...
                                                                    <div class="mb-12 col-md-12">
                                                <label class="form-label">العدد*</label>
                        <input type="text" onkeypress="return event.charCode >= 46 && event.charCode <= 58" id="edit_count" class="form-control @error('price') is-invalid @enderror" name="count" value="{{ old('count') }}" placeholder="العدد" Required>
                                                   @error('count')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                                    ...
                                    <div class="modal fade" id="Modaldel">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                                <form method="post" action="del_sak">
                                        @csrf
                                    ...
                                    <table class="table table-striped table-responsive-sm" style="width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#" data-bs-toggle="modal" data-bs-target="#Modaledit" class="btn btn-primary c_edit shadow btn-xs sharp me-1" data-id="{{$g->id}}" data-name="{{$g->name}}" data-price="{{$g->price}}"  data-price2="{{$g->price2}}" data-count="{{$g->counts}}"><i class="fa fa-pencil"></i></a></td>
...
$(document).ready(function() {
    $(".c_edit").on('click',function(){
      ...
      let price2=$(this).attr('data-price2');
