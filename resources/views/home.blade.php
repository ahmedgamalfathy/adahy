    ...
    margin-right: 15px;
        ...
        ***********************************-->
        <div class="content-body">
							...
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num">
									    {{DB::table('adahyt')->where('gov',12)->count();}}
									</h2>
					...
					<div class="col-xl-3 col-xxl-6 col-sm-6">
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num">  {{DB::table('adahyt')->where('gov',12)->sum('reservation')
									-
						DB::table('reservation')->where('gov_type',12)->where('emp','=','website')->sum('sak');}}</h2>
									<span class="text-white fs-18">
									    صكوك تم حجزها
									</span>
								</div>
					...
					<div class="col-xl-3 col-xxl-6 col-sm-6">
						<div class="card bg-info invoice-card">
							<div class="card-body d-flex">
								...
								<div>
			<h2 class="text-white invoice-num">{{DB::table('adahyt')->where('gov',12)->sum('free')
			+
			DB::table('reservation')->where('gov_type',12)->where('emp','=','website')->sum('sak')
			;
			}}</h2>
									<span class="text-white fs-18"> 
									صكوك متاحة
					...
					<div class="col-xl-3 col-xxl-6 col-sm-6">
						<div class="card bg-secondary invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num">{{DB::table('adahyt')->where('gov',12)->sum('sak_c');}}</h2>
									<span class="text-white fs-18">  
									إجمالى عدد الصكوك
									</span>
								</div>
		  ...
		  {{DB::table('adahyt')->where('gov',12)->where('days','=','اليوم الأول')->sum('reservation') -
		  DB::table('reservation')->where('gov_type',12)->where('days','=','اليوم الأول')->where('emp','=','website')
->sum('sak')		  ;}}
													    </span></li>
													<li><span class="bg-success circle"></span>اليوم الثانى<span>
			 {{DB::table('adahyt')->where('gov',12)->where('days','=','اليوم الثانى')->sum('reservation')
			 -
			 DB::table('reservation')->where('gov_type',12)->where('days','=','اليوم الثانى')->where('emp','=','website')
->sum('sak')
			 ;}}
													    </span></li>
													<li><span class="bg-warning circle"></span>اليوم الثالث<span>
													  ...
													  $search = "الثالث";
													  @endphp
			 {{DB::table('adahyt')->where('gov',12)->where('days','LIKE', '%'.$search.'%')->sum('reservation')
			 -
			 DB::table('reservation')->where('gov_type',12)->where('days','LIKE', '%'.$search.'%')->where('emp','=','website')
->sum('sak')
			 ;}}
													    </span></li>
											...
											<div class="col-md-4">
												...
												<ul class="card-list mt-4">
													<li><span class="bg-blue circle"></span>اليوم الأول<span>
			 {{DB::table('adahyt')->where('gov',12)->where('days','=','اليوم الأول')->sum('free') 
			 +
			 	  DB::table('reservation')->where('gov_type',12)->where('days','=','اليوم الأول')->where('emp','=','website')
->sum('sak')
			 ;}}
													...
													<li><span class="bg-success circle"></span>اليوم الثانى<span>
				  {{DB::table('adahyt')->where('gov',12)->where('days','=','اليوم الثانى')->sum('free') 
				  +
				  	  DB::table('reservation')->where('gov_type',12)->where('days','=','اليوم الثانى')->where('emp','=','website')
->sum('sak')
				  ...
				  ;}}
													...
													<li><span class="bg-warning circle"></span>اليوم الثالث<span>
													  ...
													  $search = "الثالث";
													  @endphp
			 {{DB::table('adahyt')->where('gov',12)->where('days','LIKE', '%'.$search.'%')->sum('free')
			 +
			 		 DB::table('reservation')->where('gov_type',12)->where('days','LIKE', '%'.$search.'%')->where('emp','=','website')
->sum('sak')
			 ; }}
												...
												<ul class="card-list mt-4">
													<li><span class="bg-blue circle"></span>اليوم الأول<span>
													    {{DB::table('adahyt')->where('gov',12)->where('days','=','اليوم الأول')->count();}}
													    </span></li>
													<li><span class="bg-success circle"></span>اليوم الثانى<span>
													    {{DB::table('adahyt')->where('gov',12)->where('days','=','اليوم الثانى')->count();}}
													    </span></li>
													<li><span class="bg-warning circle"></span>اليوم الثالث<span>
													  @php
													  $search = "الثالث";
													  @endphp
													    {{DB::table('adahyt')->where('gov',12)->where('days','LIKE', '%'.$search.'%')->count();}}
													    </span></li>
                                    ...
                                    <table class="table table-striped table-responsive-sm">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th>اليوم الأول</th>
                                                 @foreach($get_type as $gt)
                             <td> {{DB::table('adahyt')->where('gov',12)->where('free','>',0)->where('adahy','=',$gt->name)->where('days','=','اليوم الأول')->count()
                             +
                             ...
                             ;}}</td>
                                            @endforeach
                                              ...
                                              <tr>
                                                <th>اليوم الثانى</th>
                                                     @foreach($get_type as $gt)
                             <td> {{DB::table('adahyt')->where('gov',12)->where('free','>',0)->where('adahy','=',$gt->name)->where('days','=','اليوم الثانى')->count() 
                             +
                               DB::table('reservation')
		 ->where('gov_type',12)
         ->where('adahy','=',$gt->name)
         ...
         ->where('emp','=','website')->distinct()->count('code')
                             ...
                             @endforeach
                                              ...
                                              <tr>
                                                <th>اليوم الثالث</th>
                                                @foreach($get_type as $gt)
                    <td> {{DB::table('adahyt')->where('gov',12)->where('free','>',0)->where('adahy','=',$gt->name)->where('days','LIKE', '%'.$search.'%')->count()
                    +
                            DB::table('reservation')
		->where('gov_type',12)							
         ->where('adahy','=',$gt->name)
         ...
         ->where('emp','=','website')->distinct()->count('code')
                    ...
                    @endforeach
                                                ...
                                                <th>الإجمالى </th>
                                                   @foreach($get_type as $gt)
                    <td> {{DB::table('adahyt')->where('gov',12)->where('free','>',0)->where('adahy','=',$gt->name)->count()
                    +
                       DB::table('reservation')
		 ->where('gov_type',12)					
         ->where('adahy','=',$gt->name)
