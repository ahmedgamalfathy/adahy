    ...
    margin-right: 15px;
        ...
        ***********************************-->
        <div class="content-body">
							...
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num">
									    {{DB::table('adahyt')->where('gov',01)->count();}}
									</h2>
					...
					<div class="col-xl-3 col-xxl-6 col-sm-6">
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num">  {{DB::table('adahyt')->where('gov',01)->sum('reservation')
									-
						DB::table('reservation')->where('gov_type',01)->where('emp','=','website')->sum('sak');}}</h2>
									<span class="text-white fs-18">
									    صكوك تم حجزها
									</span>
								</div>
					...
					<div class="col-xl-3 col-xxl-6 col-sm-6">
						<div class="card bg-info invoice-card">
							<div class="card-body d-flex">
								...
								<div>
			<h2 class="text-white invoice-num">{{DB::table('adahyt')->where('gov',01)->sum('free')
			+
			DB::table('reservation')->where('gov_type',01)->where('emp','=','website')->sum('sak')
			;
			}}</h2>
									<span class="text-white fs-18"> 
									صكوك متاحة
					...
					<div class="col-xl-3 col-xxl-6 col-sm-6">
						<div class="card bg-secondary invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num">{{DB::table('adahyt')->where('gov',01)->sum('sak_c');}}</h2>
									<span class="text-white fs-18">  
									إجمالى عدد الصكوك
									</span>
								</div>
		  ...
		  {{DB::table('adahyt')->where('gov',01)->where('days','=','اليوم الأول')->sum('reservation') -
		  DB::table('reservation')->where('gov_type',01)->where('days','=','اليوم الأول')->where('emp','=','website')
->sum('sak')		  ;}}
													    </span></li>
													<li><span class="bg-success circle"></span>اليوم الثانى<span>
			 {{DB::table('adahyt')->where('gov',01)->where('days','=','اليوم الثانى')->sum('reservation')
			 -
			 DB::table('reservation')->where('gov_type',01)->where('days','=','اليوم الثانى')->where('emp','=','website')
->sum('sak')
			 ;}}
													    </span></li>
...
->sum('sak')
			 ;}}
											...
											<div class="col-md-4">
												...
												<ul class="card-list mt-4">
													<li><span class="bg-blue circle"></span>اليوم الأول<span>
			 {{DB::table('adahyt')->where('gov',01)->where('days','=','اليوم الأول')->sum('free') 
			 +
			 	  DB::table('reservation')->where('gov_type',01)->where('days','=','اليوم الأول')->where('emp','=','website')
->sum('sak')
			 ;}}
													...
													<li><span class="bg-success circle"></span>اليوم الثانى<span>
				  {{DB::table('adahyt')->where('gov',01)->where('days','=','اليوم الثانى')->sum('free') 
				  +
				  	  DB::table('reservation')->where('gov_type',01)->where('days','=','اليوم الثانى')->where('emp','=','website')
->sum('sak')
...
->sum('sak')
			 ; }}
												...
												<ul class="card-list mt-4">
													<li><span class="bg-blue circle"></span>اليوم الأول<span>
													    {{DB::table('adahyt')->where('gov',01)->where('days','=','اليوم الأول')->count();}}
													    </span></li>
													<li><span class="bg-success circle"></span>اليوم الثانى<span>
