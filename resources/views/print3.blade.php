...
<head>
    ...
    <style type="text/css" media="screen">
        .uv-tray {
            position: fixed;
            -webkit-font-smothing: antialias;
            z-index: 100000
        }

        .uv-tray.uv-bottom-right {
            bottom: 10px;
            right: 10px
        }

        .uv-tray.uv-top-right {
            top: 10px;
            right: 10px
        }

        .uv-tray.uv-bottom-left {
            bottom: 10px;
            left: 10px
        }
        ...
        .uv-ie8 .uv-tray-item {
            background: url(//widget.uservoice.com/images/clients/widget_environment/sixty_percent.png)
        }

        .uv-tray-item-hoverinfo {
            display: block;
            opacity: 0;
        ...
        .uv-top-left .uv-tray-item-hoverinfo,
        .uv-bottom-left .uv-tray-item-hoverinfo {
            padding-left: 24px
        }

        .uv-top-right .uv-tray-item-hoverinfo,
        .uv-bottom-right .uv-tray-item-hoverinfo {
            padding-left: 48px
        }
        ...
        .uv-top-right .uv-tray-item-icon,
        .uv-bottom-right .uv-tray-item-icon {
            right: 0
        }

        .uv-top-left .uv-tray-item-icon,
        .uv-bottom-left .uv-tray-item-icon {
            left: 0
        }

        .uv-tray-item-icon svg {
            width: 48px;
            height: 48px
        }

        .uv-init .uv-tray-item {
            background: rgba(46, 49, 51, 0.9);
            width: 245px
        }

        .uv-init .uv-tray-item .uv-tray-item-hoverinfo {
            opacity: 1;
        ...
        .uv-init .uv-tray-item .uv-tray-item-icon {
            opacity: 1
        }

        .uv-ie8 .uv-init .uv-tray-item {
            background: url(//widget.uservoice.com/images/clients/widget_environment/ninety_percent.png)
        }

        .uv-init.uv-top-right .uv-tray-item-hoverinfo,
        .uv-init.uv-bottom-right .uv-tray-item-hoverinfo {
            padding-left: 0
        }
        ...
        .uv-ie8 .uv-tray-item:hover {
            background: url(//widget.uservoice.com/images/clients/widget_environment/ninety_percent.png)
        }

        .uv-tray-item .uv-tray-item-hoverinfo {
            opacity: 0
        }

        .uv-tray-item .uv-tray-item-icon {
            opacity: 1
        }

        .uv-tray-item.uv-is-selected {
            background: rgba(46, 49, 51, 0.75)
        }

        .uv-ie8 .uv-tray-item.uv-is-selected {
            background: url(//widget.uservoice.com/images/clients/widget_environment/seventy_five_percent.png)
        }

        .uv-tray-item.uv-is-selected:hover {
            background: rgba(46, 49, 51, 0.9)
        }

        .uv-ie8 .uv-tray-item.uv-is-selected:hover {
            background: url(//widget.uservoice.com/images/clients/widget_environment/ninety_percent.png)
        }
        ...
        .uv-top-right .uv-popover {
            top: 54px;
            right: 4px
        }

        .uv-top-left .uv-popover {
            top: 54px;
            left: 4px
        }

        .uv-bottom-right .uv-popover {
            bottom: 54px;
            right: 4px
        }

        .uv-bottom-left .uv-popover {
            bottom: 54px;
            left: 4px
        }
        ...
        .uv-top-left .uv-popover-content,
        .uv-top-right .uv-popover-content,
        .uv-below .uv-popover-content {
        ...
        .uv-bottom-left .uv-popover-content,
        .uv-bottom-right .uv-popover-content,
        .uv-above .uv-popover-content {
            -webkit-box-shadow: rgba(0, 0, 0, 0.3) 0 10px 60px, rgba(0, 0, 0, 0.1) 0 0 20px;
            -moz-box-shadow: rgba(0, 0, 0, 0.3) 0 10px 60px, rgba(0, 0, 0, 0.1) 0 0 20px;
            box-shadow: rgba(0, 0, 0, 0.3) 0 10px 60px, rgba(0, 0, 0, 0.1) 0 0 20px
        }
        ...
        @media screen and (max-device-width: 480px) {
            .uv-popover-content {
                -webkit-box-shadow: rgba(0, 0, 0, 0.6) 0 10px 60px, rgba(0, 0, 0, 0.2) 0 0 20px;
                -moz-box-shadow: rgba(0, 0, 0, 0.6) 0 10px 60px, rgba(0, 0, 0, 0.2) 0 0 20px;
                box-shadow: rgba(0, 0, 0, 0.6) 0 10px 60px, rgba(0, 0, 0, 0.2) 0 0 20px;
                height: 100%;
                width: 100%
            }
        }
        ...
        .uv-top-left .uv-popover-tail,
        .uv-bottom-left .uv-popover-tail {
            margin-left: 12px
        }

        .uv-top-right .uv-popover-tail,
        .uv-bottom-right .uv-popover-tail {
            margin-left: 297px
        }

        .uv-bottom-left .uv-popover-tail,
        .uv-bottom-right .uv-popover-tail,
        .uv-above .uv-popover-tail {
            border-bottom: none;
            border-top: 12px solid #f0f3f7
        }

        .uv-top-left .uv-popover-tail,
        .uv-top-right .uv-popover-tail,
        .uv-below .uv-popover-tail {
            border-top: none;
        ...
        @media screen and (max-device-width: 480px) {
            ...
            .uv-popover-controls-hidden .uv-popover-iframe-container {
                height: auto
            }
        }
        ...
        .uv-popover-controls {
            ...
            -moz-transition: all 600ms 600ms;
            -o-transition: all 600ms 600ms;
            transition: all 600ms 600ms;
            height: 42px;
            overflow: hidden
        }

        .uv-popover-controls-hidden .uv-popover-controls {
            opacity: 0;
            height: 0;
            padding: 0 10px
        }
        ...
        .uv-popover-button:focus {
            outline: none
        }

        .uv-popover-button:hover {
            border-top: 1px solid #a0c1e4;
            color: #314f70
        }

        .uv-reversed .uv-popover-button {
        ...
        .uv-top-right .uv-bubble,
        .uv-top-left .uv-bubble {
            top: 48px;
            padding-top: 12px
        }

        .uv-bottom-right .uv-bubble,
        .uv-bottom-left .uv-bubble {
            bottom: 48px;
            padding-bottom: 12px
        }
        ...
        .uv-bottom-left .uv-bubble-tail,
        .uv-bottom-right .uv-bubble-tail {
            border-top: 8px solid rgba(46, 49, 51, 0.9);
            border-bottom: none
        }

        .uv-top-left .uv-bubble-tail,
        .uv-top-right .uv-bubble-tail {
            border-bottom: 8px solid rgba(46, 49, 51, 0.9);
            border-top: none;
            top: 4px
        }

        .uv-ie8 .uv-bubble-tail {
            border: none;
            background: url(//widget.uservoice.com/images/clients/widget_environment/bubble_tail.png);
            width: 12px;
            height: 8px
        }

        .uv-ie8.uv-top-left .uv-bubble-tail,
        .uv-ie8.uv-top-right .uv-bubble-tail {
            background: url(//widget.uservoice.com/images/clients/widget_environment/bubble_tail_up.png)
        }
...
$get_ = DB::table('reservation')->where('id',$id)->first();
$get_ad = DB::table('adahyt')->where('code',$get_ ->code)->first();
$gopt = DB::table('opt')->where('code',$get_->code)->first();
    ...
    <div class="border">
        ...
        <div class="wrap" style="height: auto;">
            ...
            <header style="margin-top: -35px;">
                <img src="/invo/head-2.png">


                <br>
            </header>
            <div style="direction: rtl ; font-size: 12px ; font-weight: bold ; MARGIN-TOP: -1PX">
                <article>
                    <form name="f" action="#" method="post">
                        ...
                        <address contenteditable="0" style="">
                            ...
                            <div style="">
                                ...
                                <table class="meta"
                                    style=" float: left ; width: 100%; margin-top: -5%; margin-bottom: -6px !important;">
                                   <tbody>
...
font-size: 22px;"><input type="text" style="width: 100%;    text-align: center;" name="date" value="{{$get_->name}}" readonly="">
                                            </td>
...
font-size: 22px;"><span contenteditable="0">
                                            ...
                                            <td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
font-size: 22px;"><input type="text" style="width: 100%;    text-align: center;" name="date" value="{{$get_->code}}" readonly="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th id="invoice_id_label" style=" direction: rtl ;     text-align: center;
font-size: 22px;"><span contenteditable="0">
                                            ...
                                            <td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
font-size: 22px;"><input type="text" style="width: 100%;    text-align: center;" name="date" value="@if($gopt != null){{$gopt->r_exit_date}}@endif" readonly="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th id="invoice_id_label" style=" direction: rtl ;     text-align: center;
font-size: 22px;"><span contenteditable="0">
                                            ...
                                            <td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
font-size: 22px;"><input type="text" style="width: 100%;    text-align: center;" name="date" value="{{$get_->days}}" readonly="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th id="invoice_id_label" style=" direction: rtl ;     text-align: center;
font-size: 22px;"><span contenteditable="0">
                                            ...
                                            <td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
font-size: 22px;"><input type="text" style="width: 100%;    text-align: center;" name="date" value="{{$get_->saks}}" readonly="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th id="invoice_id_label" style=" direction: rtl ;     text-align: center;
...
font-size: 22px;"><span contenteditable="0">
                                            ...
                                            <td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
font-size: 22px;"><input type="text" style="width: 100%;    text-align: center;" name="date" value="1" readonly="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th id="invoice_id_label" style=" direction: rtl ;     text-align: center;
font-size: 22px;"><span contenteditable="0">
                                                    إجمالي المستلم من اللحم + الكبدة
                                                </span></th>
                                            <td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
font-size: 22px;"><input type="text" style="width: 100%;    text-align: center;" name="date" value="@if($gopt != null){{$gopt->f_weight + $gopt->f_weight2}}@endif" readonly="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th id="invoice_id_label" style=" direction: rtl ;     text-align: center;
font-size: 22px;"><span contenteditable="0">
                                            ...
                                            <td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
font-size: 22px;"><input type="text" style="width: 100%;    text-align: center;" name="date" value="@if($gopt != null){{@$gopt->f_weight}}@endif" readonly="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th id="invoice_id_label" style=" direction: rtl ;     text-align: center;
font-size: 22px;"><span contenteditable="0">
                                            ...
                                            <td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
font-size: 22px;"><input type="text" style="width: 100%;    text-align: center;" name="date" value="@if($gopt != null){{@$gopt->f_weight2}}@endif" readonly="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th id="invoice_id_label" style=" direction: rtl ;     text-align: center;
...
font-size: 22px;"><span contenteditable="0">
                                            ...
                                            <td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
font-size: 22px;"><input type="text" style="width: 100%;    text-align: center;" name="date" value="" readonly="">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
