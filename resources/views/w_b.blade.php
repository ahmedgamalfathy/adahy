...
">
                         ...
                         <table class="table">
                            ...
                            <td>{{$g->w_agent}}</td>
                                    ...
                                    <div class="modal fade" id="Modaladd{{$g->id}}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                                <form method="post" action="add_wb">
                                        @csrf
    ...
    font-weight: bold;">
                                ...
                                <input type="text"  class="form-control @error('wb_note') is-invalid @enderror" name="wb_note" id="wb_note" value="{{$g->wb_note}}" placeholder="ملاحظات   " >
                                                 ...
                                                 <td>
                                                     ...
                                                     @endphp
                                                       <a href="#" class="btn btn-success   shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target="#Modaladda{{$g->id}}"><i class="fa fa-pencil"></i></a> 
                                                                ...
                                                                <!-- Modal edit-->
                                    <div class="modal fade" id="Modaladda{{$g->id}}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                                <form method="post" action="add_wb_ex">
                                        @csrf
