					...
					<div class="col-xl-3 col-xxl-6 col-sm-6 d-none d-sm-block">
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"> 
										    {{DB::table('opt')->whereIN('type',[5,6])->where('f_exit_date','=',0)->count()}}
									</h2>
									<span class="text-white fs-18">
									    مرحلةالتعبئة
									</span>
...
">
                                    ...
                                    <table  id="example" class="display" style="width: 100%;">
                                        <thead>
                                            <tr> 
                                                ...
                                                <th>الوزن</th>
                                                <th>الجزارة</th>             
                                                 <th class="d-none">تنظبف السقط</th>
                                                <th>إجراء</th>
                                             <th>وقت الدخول</th>
                                                <th>غرفة التعبئة</th>
                                                <th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$g->days}}</td>
                                                <td>
                                                    <a href="#" onclick="window.open('/note/{{$g->code}}','popup','width=783,height=475,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=350,top=50'); return false">
    ...
    font-weight: bold;">
                         ...
                         <table class="table table-striped table-responsive-sm">
                            ...
                            <td>{{$g->w_agent}}</td>
                                          ...
                                          <td>
                                                <a href="#" class="btn btn-warning  shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target="#Modaleinfo_3{{$g->id}}">
                                                  <i class="flaticon-050-info"></i>
                            </a>        
                                                                                    <!-- Modal info-->
                                        <div class="modal fade" id="Modaleinfo_3{{$g->id}}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
    ...
    font-weight: bold;">
                         ...
                         <table class="table table-striped table-responsive-sm">
                            ...
                            <td>{{$g->b_agent}}</td>
                                          ...
                                          <td class="d-none">
                                                <a href="#" class="btn btn-warning  shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target="#Modaleinfo_4{{$g->id}}">
                                                  <i class="flaticon-050-info"></i>
                            </a>        
                                                                                    <!-- Modal info-->
                                    <div class="modal fade" id="Modaleinfo_4{{$g->id}}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
    ...
    font-weight: bold;">
                  ...
                  <form method="post" action="add_pkg">
                                        @csrf
                                                
                        <input type="hidden" name="code" id="edit_id" value="{{$g->code}}">
                        <div class="modal-header">
                            <h5 class="modal-title">{{$g->code}}-{{$g->sak}}  مرحلة التعبئة </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal">
                            </button>
                        </div>
                        <div class="modal-body" style="direction: rtl;
                        ...
                        font-weight: bold;">
                            ...
                            <input type="hidden" name="f_weight" id="f_note" value="{{$g->f_weight}}">     <!-- وزن اللحم بعد التشفية -->             
                            <input type="hidden" name="f_weight2" id="f_note" value="{{$g->f_weight2}}">     <!-- وزن الكبدة -->             
                            <input type="hidden" name="f_note" id="f_note" value="{{$g->f_note}}">     <!-- الملاحظات -->             
                            <input type="hidden" name="f_exit_date" id="f_note" value="{{$g->f_exit_date}}"> <!-- وقت الخروج -->               
                                                 
                            {{-- <div class="mb-12 col-md-12 d-none">
                            <label class="form-label">وزن اللحم بعد التشفية</label>
                            <input type="text"  class="form-control @error('f_weight') is-invalid @enderror"
                            onkeypress="return event.charCode >= 46 && event.charCode <= 58"
                            name="f_weight" id="f_weight" value="{{$g->f_weight}}" placeholder=" وزن اللحم بعد التشفية " >
                            @error('f_weight')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
                            ...
                            {{-- <div class="mb-12 col-md-12 d-none">
                            <label class="form-label">وزن الكبدة</label>
                            <input type="text"  class="form-control @error('f_weight2') is-invalid @enderror"
                            onkeypress="return event.charCode >= 46 && event.charCode <= 58"
                            name="f_weight2" id="f_weight2" value="{{$g->f_weight2}}" placeholder=" وزن الكبدة   " >
                            @error('f_weight2')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
                            ...
                            <input type="text"  class="form-control @error('f_note') is-invalid @enderror" name="f_note" id="f_note" value="{{$g->f_note}}" placeholder="ملاحظات   " >
                            @error('f_note')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
                            ...
                            {{-- <div class="mb-12 col-md-12 d-none">
                            <label class="form-label">وقت خروج   </label>
                            <input type="time" name="f_exit_date" id="f_exit_date" class="form-control"  value="{{$g->f_exit_date}}">        
                            ...
                            @enderror
                                    ...
                                    <a href="#" class="{{$g->f_entry_date >0 ? "btn btn-warning  shadow btn-xs sharp me-1":"btn btn-success  shadow btn-xs sharp me-1" }}" data-bs-toggle="modal" data-bs-target="#Modaledit{{$g->id}}"><i class="fa fa-pencil"></i></a>                            
               
                                </td>
                                                <td>{{$g->f_entry_date}}</td>
                                                <td>{{$g->f_room}}</td>
                                                <td>{{$g->f_follower}}</td>
                                                 <td>{{$g->f_weight}}</td>
                                                  <td>{{$g->f_weight2}}</td>
                                                ...
                                                <td >{{$g->fb_note >0  ?  $g->fb_note : "لايوجد"}}</td>
                                 ...
                                 <td>
                                    ...
                                    @if ($g->f_entry_date> 0)
                                      ...
                                      <div class="modal fade" id="ModaleditTow{{$g->id}}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                  ...
                  <form method="post" action="add_pkg">
                        ...
                        <div class="modal-header">
                            ...
                            <input type="hidden" name="f_entry_date" id="f_note" value="{{$g->f_entry_date}}">     <!-- وقت الدخول -->             
                            <input type="hidden" name="f_room" id="f_note" value="{{$g->f_room}}">     <!-- الغرفة -->             
                            <input type="hidden" name="f_follower" id="f_note" value="{{$g->f_follower}}">     <!-- المشرف -->                  
                        <div class="modal-body" style="direction: rtl;
                        font-size: 18px;
                        padding: 25px;
                        font-weight: bold;">
                            ...
                            <input type="text"  class="form-control @error('f_weight') is-invalid @enderror"
                            onkeypress="return event.charCode >= 46 && event.charCode <= 58"
                            name="f_weight" id="f_weight" value="{{$g->f_weight}}" placeholder=" وزن اللحم بعد التشفية " required >
                            @error('f_weight')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
                            ...
                            <input type="text"  class="form-control @error('f_weight2') is-invalid @enderror"
                            onkeypress="return event.charCode >= 46 && event.charCode <= 58"
                            name="f_weight2" id="f_weight2" value="{{$g->f_weight2}}" placeholder=" وزن الكبدة   "  required >
                            @error('f_weight2')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
                            ...
                            @enderror
                                    ...
                                    <a href="#" class="btn btn-success  shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target="#ModaleditTow{{$g->id}}"><i class="fa fa-pencil"></i></a>    
                                   @endif
                                </td>
