  ...
  @endphp 	
    ...
    function checksak(){
        ...
        if(sum > c){
            ...
            document.getElementById("sub").value = "خطأ فى توزيع الصكوك";
            return false;
        }else{
...
<body>
  	...
  	<div class="div">
			...
			@endphp
    		<form action="res_posts_" method="post">
    		        @csrf
                								...
                								<div class="body">
                  									<div class="text-box-with-caption-parent">
                    										<div class="text-box-with-caption">
                      											<div class="wrapper1">
                        												<div class="for-preview">المدينة / القرية</div>
                      											</div>
                      									<input name="city[]" id="city{{$x}}" style="    height: 40px;" class="form-control" >
                    										</div>
                    										<div class="text-box-with-caption">
                      											<div class="wrapper1">
                        												<div class="for-preview">المحافظة</div>
                      											</div>
																  <select name="gov[]" class="form-control" style="height: 40px;" required>
                  									...
                  									<div class="text-box-with-caption2">
                    										<div class="wrapper1">
                      											<div class="for-preview">المنطقة / العنوان</div>
                    										</div>
                    									<input name="address[]" id="address{{$x}}" class="form-control" >
                  									</div>
                								</div>
                								<div class="title1">
                  									<div class="div15">معلومات أخرى</div>
                								</div>
              							</div>
                								...
                								<div class="body1">
													...
													<!-- id="myField" required oninvalid="this.setCustomValidity('يرجى ملء هذا الحقل.')" oninput="this.setCustomValidity('')" placeholder="ملاحظات إضافية" -->
                  									...
                  									<div class="text-box-with-caption">
                    									...
                    									<input name="notes[]" onkeypress="return event.charCode >= 48 && event.charCode <= 57" id="notes{{$x}}" value="{{$sak_price}}" class="form-control" style="    text-align: center;" required="required">
                  									</div>
                								</div>
                								<div class="title3">
              							...
              							<div class="general-information-frame">
                								<div class="body2">
                  									<div class="text-box-with-caption2">
                    										...
                    										<input name="name[]" id="name{{$x}}" class="form-control" required="required">
                  									</div>
										...
										<input type="checkbox" class="form-check-input" name="whatsd"  id="whatsd{{$x}}" >
              							...
              							<div class="al-sa2t-frame">
                								<div class="body3">
                  									<div class="div27">
                    										<div class="div28">
                      											<div class="circle-alert-wrapper">
        ...
        if (checkedBoxes > ss) {
            ...
            $('#message').text('');
      			...
      			<div class="btn-parent" style="margin-top:-1%;    margin-bottom: 3%;width: 50%;">
        				...
        				<input type="submit" id="sub" style="color: #fff;width: 50%;
    border-color: #0ebf15;" class="btn1" id="btnContainer1" value="الخطوة التالية" >
          					...
          					<div class="select-number">
            						...
            						<div class="select-item36">
            						    <div class="div31">{{$c_persons}}</div>
              							<div class="for-preview">عدة أشخاص</div>
