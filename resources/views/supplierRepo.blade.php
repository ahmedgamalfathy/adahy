                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-responsive-sm" style="width: 100%;">
                                        ...
                                        <tbody>
                                          <!-- 'totalDuseCo','totalWeightCo','totalCountCo' -->
                                            <tr>
                                                <td>{{ $get->name }}</td>
                                                <td>بقري</td>
                                                <td>{{$totalCountCo}}</td>
                                                <td>{{ number_format($totalWeightCo,2) }}</td>
                                                <td>{{$totalDuseCo}}</td>
                                            </tr>
                                            <tr><!-- 'totalDuseBuf','totalWeightBuf','totalCountBuf', -->
                                                <td>{{ $get->name }}</td>
                                                <td>جمسي</td>
                                                <td>{{$totalCountBuf}}</td>
                                                <td>{{ number_format($totalWeightBuf,2) }}</td>
                                                <td>{{$totalDuseBuf}}</td>
                                            </tr>
                                          <tr><!--'totalDuseShe','totalWeightShe','totalCountShe', -->
                                                <td>{{ $get->name }}</td>
                                                <td>خراف</td>
                                                <td>{{$totalCountShe}}</td>
                                                <td>{{ number_format($totalWeightShe,2) }}</td>
                                                <td>{{$totalDuseShe}}</td>
                                            </tr>
                                             <tr><!--'totalDuseGo','totalWeightGo','totalCountGo' -->
                                                <td>{{ $get->name }}</td>
                                                <td>ماعز</td>
                                                <td>{{$totalCountGo}}</td>
                                                <td>{{ number_format($totalWeightGo,2) }}</td>
                                                <td>{{$totalDuseGo}}</td>
                                            </tr>
