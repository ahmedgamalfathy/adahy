					...
					<div class="col-xl-3 col-xxl-6 col-sm-6">
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"> 
										    {{DB::table('opt')->where('s_exit_date','=',0)->whereIN('type',[1,2,3,4,5,6])->count()}}
									</h2>
									<span class="text-white fs-18">
									    مرحلة الملحقات
									</span>
                                    ...
                                    <table  id="example" class="display" style="width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$g->days}}</td>
                                                <td>
                                    <a href="#" style="width: 70px;" class="btn btn-warning  shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target="#Modaleinfo{{$g->id}}">
                                                    {{$g->w_weight}}
                            </a>
                                                                           <!-- Modal info-->
    ...
    font-weight: bold;">
                         ...
                         <table class="table table-striped table-responsive-sm">
                            ...
                            <td>{{$g->w_agent}}</td>
                                         ...
                                         <td>
                                                <a href="#" class="btn btn-warning  shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target="#Modaleinfo_2{{$g->id}}">
                                                  <i class="flaticon-050-info"></i>
                            </a>        
                                                                                    <!-- Modal info-->
                                    <div class="modal fade" id="Modaleinfo_2{{$g->id}}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                    ...
                                    <div class="modal fade" id="Modaledit{{$g->id}}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                              ...
                                                              <form method="post" action="add_accessories">
                                        @csrf
                                                
                                                <input type="hidden" name="code" id="edit_id" value="{{$g->code}}">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"> مرحلة الملحقات </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                                                    </button>
                                                </div>
                                                <div class="modal-body" style="direction: rtl;
    ...
    font-weight: bold;">
                     ...
                     @php echo $all_f; @endphp
                                ...
                                @enderror
                                                      ...
                                                      <div class="mb-12 col-md-12">
                                                <label class="form-label">وزن الدهن  </label>
                        
                 <input type="text"  class="form-control @error('b_weight') is-invalid @enderror"
                 onkeypress="return event.charCode >= 46 && event.charCode <= 58"
                 name="s_weight" id="s_weight" value="{{$g->s_weight}}" placeholder="وزن الشقتين" >
                 ...
                 <input type="text"  class="form-control @error('b_weight2') is-invalid @enderror"
                 onkeypress="return event.charCode >= 46 && event.charCode <= 58"
                 name="s_weight2" id="s_weight" value="{{$g->s_weight2}}" placeholder="وزن الكبدة / القلب / الكلاوي " >
                                ...
                                <input type="text"  class="form-control @error('s_note') is-invalid @enderror" name="s_note" id="s_note" value="{{$g->s_note}}" placeholder="ملاحظات   " >
                                ...
                                @enderror
                                          ...
                                          <input type="time" name="s_exit_date" id="s_exit_date" class="form-control" >        
