					...
					<div class="col-xl-3 col-xxl-6 col-sm-6 d-none d-sm-block">
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"> 
										    {{DB::table('opt')->whereIN('type',[6,7])->where('r_exit_date','=',0)->count()}}
									</h2>
									<span class="text-white fs-18">
									    مرحلةالتعبئة
									</span>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table  id="example" class="display" style="width: 100%;">
                                        ...
                                        <tbody>
                                            @foreach($get as $g)
                                            <tr style="{{ $g->type == 7 ? 'background-color: #f9e6b2 !important;' : ''}}">
                                                ...
                                                <td>{{$g->days}}</td>
                                                <td>
                                    <a href="#" style="width: 40px;font-weight:bold;" class="btn btn-warning  shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target="#Modaleinfo{{$g->id}}">
                                                    {{$g->w_weight}}
                            </a>
                                                                           <!-- Modal info-->
                         ...
                         <table class="table table-striped table-responsive-sm">
                            ...
                            <td>{{$g->d_agent}}</td>
                                                ...
                                                <div class="modal-footer">
                                                   ...
                                                   <td>
                                                <a href="#" class="btn btn-warning  shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target="#Modaleinfo_5{{$g->id}}">
                                                  <i class="flaticon-050-info"></i>
                            </a>        
                                                                                    <!-- Modal info-->
                                    <div class="modal fade" id="Modaleinfo_5{{$g->id}}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
    ...
    font-weight: bold;">
                         ...
                         <table class="table table-striped table-responsive-sm">
                            ...
                            <td>{{$g->f_weight2}}</td>
                                ...
                                <tr>
                            <td> الوزن الصافي </td>
                            <td>{{floatval($g->f_weight2) + floatval($g->f_weight)}}</td>
                             </tr>
                                    ...
                                    <div class="modal fade" id="Modaledit{{$g->id}}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                              ...
                                                              <form method="post" action="add_rec">
                                        @csrf
                                                
                                                <input type="hidden" name="code" id="edit_id" value="{{$g->code}}">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"> مرحلة التسليم </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                                                    </button>
                                                </div>
                                                <div class="modal-body" style="direction: rtl;
    ...
    font-weight: bold;">
                     ...
                     <a href="#" class="btn btn-success   shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target="#Modaladd{{$g->id}}"><i class="fa fa-pencil"></i></a> 
                                        ...
                                        <td>{{$getsak->rec}}</td>
                                                ...
                                                <td>{{$getsak->name}}</td>
                                                <td>{{$getsak->mobile}}</td>
                                                <td>{{$getsak->mobile2}}</td>
                                                <td>{{$getsak->zone}}</td>
                                                <td>{{$getsak->address}}</td>
                                                <td>{{$getsak->note}}</td>
