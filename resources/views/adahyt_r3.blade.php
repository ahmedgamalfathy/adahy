...
<body>
  	...
  	<div class="div">
    	...
    	<div class="frame-parent">
			...
			header('Location: ' . url("adahyt_r?gov={$info->gov}")); // غيّر الرابط لمسار الصفحة المناسبة
			exit;
            }
			...
			@endphp
    		<form action="res_posts" method="post" id="reservationForm">
    		        @csrf
              							...
              							<div class="the-notes-frame">
                								<div class="body1">
													<div class="text-box-with-caption2">
														...
														<input name="description[]" id="description{{$x}}"class="form-control"  >
													</div>
                  									<div class="text-box-with-caption">
                    										<div class="wrapper1">
                      											<div class="for-preview">   
											...
											<label class="form-check-label" for="whats{{$x}}">
												...
												<input type="checkbox" class="form-check-input" name="whats"  id="whats{{$x}}" >
                    										...
                    										<div class="text-box-with-caption5">
																  ...
																  <input name="mobile[]" id="mobile{{$x}}" maxlength="11" minlength="11" pattern="[0-9]{11}" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" required oninvalid="this.setCustomValidity('يجب إدخال 11 رقم بالضبط')" oninput="this.setCustomValidity('')">                    										</div>
                  									</div>
                  									<div class="select-item-parent">
                    										<div class="select-item1">
                      															<div class="form-check custom-checkbox mb-3 checkbox-info">
