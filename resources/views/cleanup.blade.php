					...
					<div class="col-xl-3 col-xxl-6 col-sm-6">
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"> 
										    {{DB::table('opt')->whereIN('type',[1,2,3,4,5,6])->where('d_exit_date','=',0)->count()}}
									</h2>
									<span class="text-white fs-18">
									    مرحلة تنظيف السقط
									</span>
...
">
                                    ...
                                    <div class="modal fade" id="Modaledit{{$g->id}}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                              ...
                                                              <form method="post" action="add_cleanup">
                                        @csrf
                                                
                                                <input type="hidden" name="code" id="edit_id" value="{{$g->code}}">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"> مرحلة تنظيف السقط </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                                                    </button>
                                                </div>
                                                <div class="modal-body" style="direction: rtl;
    ...
    font-weight: bold;">
                                ...
                                @enderror
                                                      ...
                                                      <input type="hidden" name="d_room" value="1" required="Required" >
                                                       <input type="hidden" id="d_teacher" name="d_teacher" value="1" required="Required" >
                     ...
                     <? echo $all_f; ?>
                                ...
                                @enderror
                                                       ...
                                                       <label class="form-label">تقييم معلم التنظيب  
                        ...
                        <select class="form-control  @error('d_aduit') is-invalid @enderror" id="d_aduit" name="d_aduit"  >
                          ...
                          >
                             مقبول
                                ...
                                <input type="text"  class="form-control @error('d_note') is-invalid @enderror" name="d_note" id="d_note" value="{{$g->d_note}}" placeholder="ملاحظات   " >
                                ...
                                @enderror
                                          ...
                                          <input type="time" name="d_exit_date" id="d_exit_date" class="form-control"  value="{{$g->d_exit_date}}">        
                        ...
                        <a href="#" class="btn btn-warning  shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target="#Modaledit{{$g->id}}"><i class="fa fa-pencil"></i></a>                            
                                    ...
                                    <div class="modal fade" id="Modaladd{{$g->id}}">
                                        ...
                                        @csrf
                                                ...
                                                <input type="hidden" name="code" id="edit_id" value="{{$g->code}}">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">اضافة- مرحلة تنظيف السقط </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                                                    </button>
                                                </div>
                                                <div class="modal-body" style="direction: rtl;
