						...
						<div class="card overflow-hidden">
							...
							<div class="row">
								<div class="col-12 border-end">
									<div class="pt-3 pb-3 ps-0 pe-0 text-center" style="width: 90%;">
									    @if($get_info->free != 0)
									   <form method="get" action="/reservationd2">  
							...
							<input type="hidden" name="type" value="200" >
								        <input type="hidden" name="id" value="{{$id}}" >
											...
											<input type="submit"  class="input-group-text" style="width: 33%;" value="بيع">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                       <form method="post" action="/new_reservation_">
                                        @csrf
...
<input type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="@if($c_client == 0){{ old('address') }}@else{{$get_clients->address}}@endif" placeholder="العنوان" Required>
                        ...
                        <input type="text" onkeypress="return event.charCode >= 46 && event.charCode <= 58" class="form-control @error('pay') is-invalid @enderror" name="pay" value="{{$sak_price}}"  placeholder="مبلغ الحجز" Required>
                                                   @error('pay')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <input type="text"  class="form-control @error('history') is-invalid @enderror" name="history" value="@if($c_client == 0){{ old('emp') }}@else{{$get_clients->history}}@endif" placeholder="تواريخ الحجز" >
                                ...
                                @enderror
                                        ...
                                        <button type="submit" id="follow" style="width: 50%;float: left;" class="btn btn-primary"> 
                                        حجز
                                        </button>
                                    </form>
                                </div>
