...
<img src="/invo/new-footer.png">
{{-- <img src="new-footer.png"> --}}
  ...
  <br>
    ...
    font-size: 22px;"><input type="text" style="width: 100%;    text-align: center;" name="date" value="{{$get->code}}"  readonly ></td>
    ...
    font-size: 22px;"><span contenteditable="0">
 	...
 	<td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
    font-size: 22px;"><input type="text" style="width: 100%;text-align: center;" value="{{$get_info->kilo}} كيلو" name="date"  readonly ></td>
    ...
    font-size: 22px;"><span contenteditable="0">
 	...
 	<td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
    font-size: 22px;"><input type="text" style="width: 100%; text-align: center;" name="date" value="{{(float)$sak_price2 * $get_info->sak_c}} جنيه"  readonly ></td>
