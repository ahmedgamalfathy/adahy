...
@endphp
			...
			<div style="margin:20px 5px;float: left;     width: 100%;   ">
					...
					<a href="../../home">		<button style="    width: 30%;" class="button" > الرئيسية</button></a>
...
width: 100%;
  ...
  padding-left: 0;
    ...
    position: relative;
		...
		<header style="margin-top: -35px;padding-left: 20%;padding-right: 20%;">
<img src="/img/lo1.png" style="margin-right: 5%;" >
  ...
  <br>
        ...
        <form name="f" action="#" method="post" >
            ...
            <div style="">
             		...
             		<table class="meta" style=" float: left ; width: 100%; margin-top: -5%;margin-bottom: 10px;">
				<tbody>
    ...
    font-size: 22px;"><input type="text" style="width: 100%;    text-align: center;" name="date" value="{{$get->rec}}"  readonly ></td>
    ...
    font-size: 22px;"><span contenteditable="0">
 	...
 	<td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
    font-size: 22px;"><input type="text" style="width: 100%;    text-align: center;" name="date" value="{{$get->name}}"  readonly ></td>
    ...
    font-size: 22px;"><span contenteditable="0">
 	...
 	<td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
    font-size: 22px;"><input type="text" style="width: 100%;text-align: center;" value="{{$get->mobile}} " name="date"  readonly ></td>
    ...
    font-size: 22px;"><span contenteditable="0">
 	...
 	<td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
    font-size: 22px;"><input type="text" style="width: 100%;text-align: center;" value="{{$get->mobile2}} " name="date"  readonly ></td>
    ...
    font-size: 22px;"><span contenteditable="0">
 	...
 	<td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
    font-size: 22px;"><input type="text" style="width: 100%;text-align: center;" name="date" value="{{$get->adahy}} "  readonly ></td>
    ...
    font-size: 22px;"><span contenteditable="0">
 	...
 	<td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
    font-size: 22px;"><input type="text" style="width: 100%;text-align: center;" name="date" value="{{$get_info->code}} "  readonly ></td>
    ...
    font-size: 22px;"><span contenteditable="0">
 	...
 	<td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
    font-size: 22px;"><input type="text" style="width: 100%; text-align: center;" name="date" value="{{$get->saks}} "  readonly ></td>
    ...
    font-size: 22px;"><span contenteditable="0">
 	...
 	<td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
    font-size: 22px;"><input type="text" style="width: 100%; text-align: center;" name="date" value="{{$get->number}} "  readonly ></td>
    ...
    font-size: 22px;"><span contenteditable="0">
 	...
 	<td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
    font-size: 22px;"><input type="text" style="width: 100%; text-align: center;" name="date" value="{{$get->days}} "  readonly ></td>
    ...
    font-size: 22px;"><span contenteditable="0">
 	...
 	<td id="invoice_id_value" style=" direction: rtl ; width: 100% ;     text-align: center;
    font-size: 22px;"><input type="text" style="width: 100%; text-align: center;" name="date" value="{{$loan}} "  readonly ></td>
