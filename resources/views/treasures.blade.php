    ...
    ***********************************-->
    ...
    font-weight: bold;">
          ...
          <div class="col-xl-8 col-xxl-8 col-sm-8">
					...
					@php
						$c1 = DB::table('per')->where('page','treasury_p1')->where('u_id',Auth::user()->id)->count();//صرف
						$c2 = DB::table('per')->where('page','treasury_p2')->where('u_id',Auth::user()->id)->count();//استلام
						@endphp
							...
							<div class="card-body  p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										<h4 class="mb-0">
						@if($c2 > 0)					    
				<a href="javascript:void(0);" class="btn btn-danger d-sm-inline-block " data-bs-toggle="modal" data-bs-target="#exampleModalCenter">دائن<i class="las la-signal ms-3 scale5"></i></a>
							@endif				    	
                                    ...
                                    <div class="modal fade" id="exampleModalCenter">
                                        ...
                                        <form method="post" action="/add_treasury_d">
                                        @csrf
                                        
                                        <input type="hidden" name="id" value="{{$get_info->id}}">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"> دائن  </h5>
    ...
    font-weight: bold;">
                        ...
                        <select name="trans" id="transd" class="default-select form-control wide " Required>
                            <option value="">
                                أختر نوع الحركة
                            </option>
                            <option value="1">تحويل إلى خزينة</option>
                           <option value="2">
                               تسوية دائنة
                           </option>
                            </select>
                        ...
                        <input type="text" class="form-control @error('nots') is-invalid @enderror" name="nots" value="{{ old('nots') }}" placeholder="التفاصيل" Required>
								...
								@if($c1 > 0)			    
					<a href="javascript:void(0);" class="btn btn-primary d-sm-inline-block " data-bs-toggle="modal" data-bs-target="#exampleModalCenter1">
										        مدين
                                    ...
                                    <div class="modal fade" id="exampleModalCenter1">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                        <form method="post" action="/add_treasury_m">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$get_info->id}}">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"> مدين  </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                                                    </button>
                                                </div>
                                                <div class="modal-body" style="direction: rtl;
    ...
    font-weight: bold;">
                           ...
                           <div class="mb-12 col-md-12">
                                                <label class="form-label">نوع الحركة*</label>
                        <select name="trans" id="transm" class="default-select form-control wide " Required>
                            <option value="">
                                أختر نوع الحركة
                            </option>
                            <option value="1">تحويل من خزينة</option>
                           <option value="2">
                               تسوية مدينة
                           </option>
                            </select>
 ...
 if(res == ""){
    $("#showm").html(``);  
      ...
      if(res == 2){
       ...
       <select  id="c-reason_s1" name="treasury" class="form-control" Required>
                                                                                <option value="">
                                                                                    اختر الخزينة
                                                                                </option>
 ...
 if(res == ""){
    $("#showd").html(``);  
      ...
      if(res == 2){
       ...
       $("#showd").html(`
        <label class="form-label">الخزينة *</label>
       <select  id="c-reason_s2" name="treasury" class="form-control" Required>
                                                                                <option value="">
                                                                                    اختر الخزينة
                                                                                </option>
                                                                                @foreach($get_all as $g)
