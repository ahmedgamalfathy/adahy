						...
						<div class="card overflow-hidden">
							...
							<div class="row">
								<div class="col-12 border-end">
									<div class="pt-3 pb-3 ps-0 pe-0 text-center">
									<a href="get_excel_sak" target="_blank">
...
<i class="las la-check-circle check-icon" @if($g->type == 1) style="font-size: 36px;color: var(--bs-orange);cursor: pointer;" @elseif($g->type == 2) style="font-size: 36px;color: var(--bs-green);cursor: pointer;" @else style="font-size: 36px;color: var(--bs-orange);cursor: pointer;" @endif onclick="document.getElementById('res_rev{{$g->id}}').submit();"></i>
    ...
    font-weight: bold;">
                         ...
                         <input type="text" class="form-control" onkeypress="return event.charCode >= 46 && event.charCode <= 58" value="{{$l_total}}" required="required" name="pay"
                            ...
                            <a href="/reservationsystem/{{$g->resnum}}" style="    background: #F44336;
    color: #fff;" class="btn btn-primary light me-1 px-3" target="_blank">
                               <i class="flaticon-072-printer"></i>
                                    </a>
                                    
                                    
                                        <a href="/print/{{$g->id}}" class="btn btn-primary light me-1 px-3" target="_blank">
                               <i class="flaticon-072-printer"></i>
                                    </a>
