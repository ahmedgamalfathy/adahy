...
<body>
  ...
  white-space: nowrap;">
      		...
      		<form method="get" action="resrv2" id="resrv2">
      		    
      			<div class="master-frame" >
        				<div class="btns-frame">
        				       <a href="resrv2" style="text-decoration:none;">
          					<div class="btn">
    		...
    		<div class="cards-frame" style="direction: ltr;    margin-right: 15%">
      			<div class="frame-parent">
        				<div class="select-item-parent">
          					...
          					<div class="days-tab">
            						<div @if($day == 3) class="tab-header2" @elseclass="tab-header"}>
              							<a href="resrv2?filter={{$filter}}&times={{$times}}&day=3&c_sak={{$c_sak}}&sak={{$sak}}&type={{$type}}"><div class="div26">اليوم الثالث</div>
              						</a>
            						</div>
            							<div @if($day == 2) class="tab-header2" @elseclass="tab-header"}>
              							<a href="resrv2?filter={{$filter}}&times={{$times}}&day=2&c_sak={{$c_sak}}&sak={{$sak}}&type={{$type}}">	<div class="div26">اليوم الثاني</div>
            						</a>
            						</div>
            						<div @if($day == 1 || $day == 0) class="tab-header2" @elseclass="tab-header"}>
              							<a href="resrv2?filter={{$filter}}&times={{$times}}&day=1&c_sak={{$c_sak}}&sak={{$sak}}&type={{$type}}">	<div class="div26">اليوم الأول</div>
            						</a>
            						</div>
          					</div>
        				</div>
        				    ...
        				    @endphp
          					...
          					<div class="cards-parent">
          					    ...
          					    @php
          					       ...
          					       $get_adahy = DB::table('adahyt')->where(function($query) use ($type,$sak,$day,$c_sak,$filter) {
    	...
    	<!-- Modal -->  
            						...
            						<div @if($gs->free == 0)class="cards"@elseclass="cards2"}>
              							...
              							<div class="title-number">
                								...
                								<div class="parent" @if($gs->free == 0)style="padding-left: 37%;direction: ltr;"@elsestyle="direction: ltr;"}>
