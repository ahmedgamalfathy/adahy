    ...
    font-weight: bold;">
            ...
            @endif
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Layers</a></li>
						<li class="breadcrumb-item"><a href="javascript:void(0)">Activated Layers</a></li>
					</ol>
                </div>
                <!-- row -->
                <div class="row">
	  ...
	  <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Activated Layers</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$g->p10}}</td>
                                                    ...
                                                    <td>
													<div class="d-flex">
														<a href="type_info/{{$g->id}}" target="_blank" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fa fa-pencil"></i></a>
