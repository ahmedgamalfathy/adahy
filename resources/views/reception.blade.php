...
<head>
  ...
  function get_tcall($x,$y)
  {
      ...
      if($c > 0){
          if($y == 7){return DB::table('callcenter')->where('re_id',$x)->orderBy('id','desc')->first()->dis;}
          else{
                        ...
                        <option value="1">
                         ...
                         <option value="6">
                          ...
                          انصراف المضحى
                              ...
                              <div style="margin-top:10px">
                                 <input type="text" class="form-control" name="dis" placeholder="التفاصيل" > 
                                   </div>
                        <div id="show">
