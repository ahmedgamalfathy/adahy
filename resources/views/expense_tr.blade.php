							...
							<div class="card-body  p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										<h4 class="mb-0">
						@if($c2 > 0)					    
				<a href="javascript:void(0);" class="btn btn-danger d-sm-inline-block " data-bs-toggle="modal" data-bs-target="#exampleModalCenter">استلام نقدية<i class="las la-signal ms-3 scale5"></i></a>
							@endif				    	
                                    ...
                                    <div class="modal fade" id="exampleModalCenter">
                                        ...
                                        <form method="post" action="/add_expense_d">
                                        @csrf
    ...
    font-weight: bold;">
					...
					<a href="javascript:void(0);" class="btn btn-primary d-sm-inline-block " data-bs-toggle="modal" data-bs-target="#exampleModalCenter1">
                                    ...
                                    <div class="modal fade" id="exampleModalCenter1">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                        <form method="post" action="/add_expense_m">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$get_info->id}}">
                                                <div class="modal-header">
