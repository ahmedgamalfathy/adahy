...
@media (max-width: 768px) {
  ...
  .page-box {
    width: auto; /* Reset width to allow content to shrink */
  }
}
...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
         ...
         <div class="content-body" style="width:100% ; margin-left: -1%;    margin-top: -5%;">
            <!-- row -->
  ...
  white-space: nowrap;">
      			...
      			<img class="advanced-search-child" alt="" src="Line 1.svg">
      		<form method="get" action="resrv2">
          					    ...
          					    <input type="hidden" name="filter" value="0">
            						<div class="div2">
              							<div class="div3">توقيت الذبح</div>
            										...
            										<select name="times" required="required" class="form-control" 
              							style="
  width: 100%;
          					...
          					<div class="div1">
            						<div class="div2">
              							<div class="div3">عدد الصكوك</div>
            										...
            										<input type="number" min="1" max="7" value="{{$c_sak}}" required="required" name="c_sak" style="
width: 93%;
    ...
    padding: 4%;">
    		...
    		<div class="cards-frame" style="direction: ltr;">
        				...
        				<div class="select-item-parent">
          					<div class="select-item">
            						...
            						<div class="checkbox">
              							<div class="checkboxinactivedefaulton">
                								<input type="checkbox" id="myCheckbox" class="checkboxinactivedefaulton-child">
          					...
          					<div class="days-tab">
            						<div class="tab-header">
              							<div class="div26">اليوم الثالث</div>
            						</div>
            						<div class="tab-header">
              							<div class="div26">اليوم الثاني</div>
            						</div>
            						<div class="tab-header2">
              							<div class="div26">اليوم الأول</div>
            						</div>
          					</div>
        				</div>
      ...
      <div class="modal-footer">
    	...
    	<!-- Modal -->  
            						...
            						<div @if($gs->free == 0) class="cards" @else class="cards2" @endif>
              							...
              							<img class="animal-img-icon" alt="" src="cow1.png">
