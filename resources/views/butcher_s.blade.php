...
">
                                    ...
                                    <div class="modal fade" id="Modaledit{{$g->id}}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                              ...
                                                              <form method="post" action="add_butcher_s">
                                        @csrf
                ...
                <input type="time" name="b_entry_date" id="b_entry_date" class="form-control"  value="<? echo $g->b_entry_date;?>"  required>        
                     ...
                     <? echo $all_f; ?>
                                ...
                                @enderror
                                               ...
                                               <div class="mb-12 col-md-12">
                                                <label class="form-label">الجزار *</label>
                         ...
                         <? echo $all_b; ?>
                                ...
                                @enderror
                                    ...
                                    ?>
                                                      ...
                                                      <div class="mb-12 col-md-12">
                                                <label class="form-label">وزن الشقتين  </label>
                 ...
                 name="b_weight" id="b_weight" value="{{$g->b_weight}}" placeholder="وزن الشقتين" >
                                ...
                                @enderror
                                        ...
                                        <div class="mb-12 col-md-12"> 
                                                       ...
                                                       <label class="form-label">تقييم الجزار  
                                                       <span id="e_type_v"></span>
                                                       </label>
                                                       <div class="note-adahy">
                        <select class="form-control  @error('b_aduit') is-invalid @enderror" id="b_aduit" name="b_aduit"  >
                          ...
                          >
                             مقبول
                                ...
                                <input type="text"  class="form-control @error('b_note') is-invalid @enderror" name="b_note" id="b_note" value="{{$g->b_note}}" placeholder="ملاحظات   " >
                        ...
                        <a href="#" class="btn btn-success  shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target="#Modaledit{{$g->id}}"><i class="fa fa-pencil"></i></a>                            
               
                                                </td>
                                         
                                         
                                                @if($g->b_entry_date)
                                                    <td>{{ date("h:i a", strtotime($g->b_entry_date)) }}</td>
                                                @else
                                                    <td>-</td>
                                                @endif
                                                <td>{{$g->b_room}}</td>
                                         ...
                                         ?>
                                                         ...
                                                         <!-- Modal edit-->
                                    <div class="modal fade" id="Modaledits{{$g->id}}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                
                                                              <form method="post" action="add_butcher_s2">
                                        @csrf
    ...
    font-weight: bold;">
                 ...
                 <input type="text"  class="form-control @error('b_weight') is-invalid @enderror"
                 onkeypress="return event.charCode >= 46 && event.charCode <= 58"
                 name="b_weight" id="b_weight" value="{{$g->b_weight}}" required="required" placeholder="وزن الشقتين" >
                        ...
                        <select class="form-control  @error('b_aduit') is-invalid @enderror" id="b_aduit" name="b_aduit"  >
                          ...
                          >
                             مقبول
                                ...
                                <input type="text"  class="form-control @error('b_note') is-invalid @enderror" name="b_note" id="b_note"  placeholder="ملاحظات   " >
                                ...
                                @enderror
                                                                         ...
                                                                         <div class="mb-12 col-md-12">
                                                <label class="form-label">وقت خروج الذبيحة  </label>
                                          <input type="time" name="b_exit_date" id="b_exit_date" class="form-control"  >        
